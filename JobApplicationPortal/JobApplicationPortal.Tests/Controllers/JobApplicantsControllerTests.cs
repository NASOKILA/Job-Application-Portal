...
//        public void SetUp()
//        {
//            _context = Substitute.For<JobApplicationPortalDbContext>();
...
//            var jobApplicant = new JobApplicants { Id = new Guid("0da63682-ac7f-430a-a1f2-ae539191aa3a") };
...
//            await _blobService.Received(1).UploadFileBlobAsync(model.Resume, jobApplicant.Id.ToString(), "Resumes/resume.pdf");
//        }
...
//        {
//            // Arrange
//            var id = new Guid("0da63682-ac7f-430a-a1f2-ae539191aa3a");
//            var jobApplicant = new JobApplicants { Id = id, ResumeFileName = "" };
//            _repository.GetJobApplicantByUniqueIdAsync(id.ToString()).Returns(jobApplicant);
...
//            // Arrange
//            var id = new Guid("0da63682-ac7f-430a-a1f2-ae539191aa3a");
//            var jobApplicant = new JobApplicants { Id = id, ResumeFileName = "resume.pdf" };
//            _repository.GetJobApplicantByUniqueIdAsync(id.ToString()).Returns(jobApplicant);

//            var relativePath = $"Resumes/{jobApplicant.ResumeFileName}";
//            _blobService.DownloadFileBlobAsync(id.ToString(), relativePath).Returns((byte[])null);
...
//            _blobService.DownloadFileBlobAsync(id.ToString(), relativePath).Returns(fileData);
...
//            // Arrange
//            var id = new Guid("0da63682-ac7f-430a-a1f2-ae539191aa3a");
//            _repository.GetJobApplicantByUniqueIdAsync(id).Returns((JobApplicants)null);
